...
import 'package:personalsafteynurse/Auth/logout.dart';
import 'package:personalsafteynurse/communication/android_communication.dart';
import 'package:personalsafteynurse/componants/theme.dart';
import 'package:personalsafteynurse/componants/title_text.dart';
import 'package:personalsafteynurse/models/api_response.dart';
import 'package:personalsafteynurse/others/GlobalVar.dart';
import 'package:personalsafteynurse/services/SocketHandler.dart';
import 'package:personalsafteynurse/utils/AndroidCall.dart';
import 'package:personalsafteynurse/utils/LatLngWrapper.dart';
import 'dart:async';
...
class _HomeState extends State<Home> with TickerProviderStateMixin {
  ...
  String clientName = "Walter White",
      clientEmail = "Heisenberg@ABQ.com",
      clientPhoneNumber = "01000000991",
      clientBloodType = "A+",
          ...
          return SingleChildScrollView(
            child: ConstrainedBox(
              ...
              child: Column(
                ...
                children: <Widget>[
                  _SOSElementData(
                      "User Depressito", "Near 26th St.", "15/4/2020"),
                  _SOSElementData(
                      "User Depressito", "Near 26th St.", "15/4/2020"),
                  _SOSElementData(
                      "User Depressito", "Near 26th St.", "15/4/2020"),
...
//                          disabledColor: Color(0x777fa3),
  ...
  bool RequestsAreEmpty() {
    try {
      ...
      if ((GlobalVar.Get("activerequestid", -1)) == -1) return true;
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
        ...
        child: Scaffold(
          appBar: AppBar(
            title: Text('Nurse Service',style:TextStyle(color: Colors.grey),),
            centerTitle: true,
            actions: <Widget>[
              IconButton(
